...
public class NorthSea extends SeaGraph {
	...
	protected void init() {
		...
		habours.add(new Point("cuxhaven",53.8731349,8.7131946, true));
		habours.add(new Point("buesum",54.1284081,8.8515602, true));
		habours.add(new Point("sanktpeterording",54.2942473,8.6201607, true));
		habours.add(new Point("helgoland",54.1798707,7.8916387, true));
		habours.add(new Point("wangerooge",53.7861597,7.8743442, true));
		habours.add(new Point("spiekerooge",53.7627257,7.6946148, true));
		habours.add(new Point("langerooge",53.7276637,7.4963619, true));
		habours.add(new Point("baltrum",53.7258942,7.3612792, true));
		habours.add(new Point("norderney",53.6981077,7.1650233, true));
		habours.add(new Point("juist",53.6734351,7.0001038, true));
		habours.add(new Point("norddeich",53.6298475,7.1575872, true));
		habours.add(new Point("dornumersiel",53.6821377,7.4863978, true));
		habours.add(new Point("bensersiel",53.6800879,7.5710329, true));
		habours.add(new Point("neuharlingersiel",53.7036697,7.7049972, true));
		habours.add(new Point("harlesiel",53.7109821,7.8107124, true));
		habours.add(new Point("schillig",53.7011878,8.0309291, true));
		habours.add(new Point("wilhelmshaven",53.5133104,8.1434555, true));
		habours.add(new Point("A",53.4982005,8.1970139));
		habours.add(new Point("B",53.6903922,8.2066269));
		habours.add(new Point("C",54.0551436,8.5252304));
		habours.add(new Point("D",54.1961328,8.3484391));
		habours.add(new Point("E",53.914735,7.5422124));
		habours.add(new Point("F",53.7608933,7.0843762));
		habours.add(new Point("G",53.8103857,7.4098462));
		habours.add(new Point("H",53.8487234,7.7521498));
		habours.add(new Point("I",53.6659318,7.1314222));
		habours.add(new Point("J",53.7059766,7.3549072));
		habours.add(new Point("K",53.7068074,7.5277316));
		habours.add(new Point("L",53.734233,7.7494365));
		habours.add(new Point("M",53.7460104,7.9197246));
		habours.add(new Point("N",53.983458,8.1505824));
		habours.add(new Point("hamburg",53.5402585,9.9116782, true));
		habours.add(new Point("O",53.5443387,9.8584632));
		habours.add(new Point("P",53.5597381,9.757183));
		habours.add(new Point("Q",53.5719684,9.6557496));
		habours.add(new Point("R",53.6203596,9.5453713));
		habours.add(new Point("S",53.713446,9.4790377));
		habours.add(new Point("T",53.7587323,9.4059099));
		habours.add(new Point("U",53.8594862,9.3001665));
		habours.add(new Point("V",53.8803365,9.0976061));
		habours.add(new Point("W",53.9046056,8.7240366));
		habours.add(new Point("bremerhaven",53.537562,8.573317, true));
		habours.add(new Point("X",53.678519,8.3535904));
